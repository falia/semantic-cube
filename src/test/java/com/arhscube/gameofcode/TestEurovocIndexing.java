...
public class TestEurovocIndexing extends AbstractEurovocBasedTest {
	...
	public void testFr() {
		...
		log.info("Found '{}' descriptors in text", found);
		found = Parser.findDescriptors("'La carte de base est une carte numérique multi-échelles déduite de la BD-L-TC. Il s'agit d'une représentation du bâti, des réseaux de transport, de la végétation et de l'orographie avec un minimum de couleurs de façon à permettre une superposition d'informations thématiques supplémentaires. '",fr_descriptors);
		log.info("Found '{}' descriptors in text", found);
	}
